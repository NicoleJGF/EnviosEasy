    ...
    <div class="shadow-lg rounded-2xl bg-white dark:bg-gray-700 w-full">
        ...
        <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
            ...
            <div class="text-center flex justify-between">
                <h6 class="text-sky-500 text-xl font-bold">Editando Cuadra {{$cuadra->abreviatura}}</h6>
                {{----------
            ...
            {!!Form::model($cuadra, ['route' => ['admin.cuadra.update',$cuadra],'method'=>'put'])!!}
                <div class="flex flex-wrap">
                <div class="w-full lg:w-8/12 px-4 mt-4">
                    <div class="relative w-full mb-3">
                    {!! Form::label('abreviatura', 'Cuadra:', ['class' => 'block text-sm font-medium text-sky-600 mb-2']) !!}
                ...
                <div class="w-full lg:w-4/12 px-4 mt-4">
                    <div class="relative w-full mb-5">
                        ...
                        <label class=" text-gray-500">{!! Form::radio('estado', '2', true,
                        ['class' => 'mr-2 focus:ring-blue-500 h-4 w-4 text-blue-600 border-gray-300 
                ...
                <div class="w-full lg:w-12/12 px-4 mt-4" >
                    <div class="relative w-full mb-5">
                    {!! Form::label('jiron_id', 'Jirones:', ['class' => 'block text-sm font-medium text-sky-600 mb-2']) !!}
                    {!! Form::select('jiron_id', $jiron_id, null, ['id' => 'selectOpciones', 'class' => 'block w-full mt-1 bg-white border 
                        border-gray-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-base focus:outline-none focus:ring-1 focus:ring-indigo-500
                ...
                <div class="w-full lg:w-12/12 px-4">
                    ...
                    {!! Form::textarea('descripcion', null, ['class' => 'border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white
                        ...
                        'placeholder' => 'Escribe una descripcion de la Cuadra ...']) !!}
                        @error('descripcion')
                            <span class="text-pink-800">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="w-full lg:w-12/12 px-4">
                    <div class="relative w-full mb-3  flex justify-end ">
                        {!! Form::submit('Guardar Cambios', ['class' => 'text-white bg-gradient-to-r from-sky-500 via-sky-600 to-sky-800 

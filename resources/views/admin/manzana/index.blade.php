            ...
            <div class="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 ">
                <ul class="flex items-center flex-wrap mb-6 md:mb-0">
                    <li><a href="#" class="text-sm font-normal text-gray-500
                            hover:underline mr-4 md:mr-6">Administrando Manzanas</a></li>
                </ul>
                <div class="flex sm:justify-center space-x-6">
                    <a href="{{route('admin.manzana.create')}}" class="text-gray-500 hover:text-gray-900">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            @if ($manzana->sector_manzana->count() > 0)
                                <ul>
                                    @foreach ($manzana->sector_manzana as $m)
                                        <li>{{ $m->abreviatura }}</li>
                                    @endforeach
                                </ul>
                            @else
                                <p>No se registro un sector para esta manzana.
                                    De uno a muchos
                                </p>
                            @endif
                        </td>
                        ...
                        <td class="px-6 py-4 flex justify-end gap-4">
                            <a x-data="{ tooltip: 'Edite' }" href="{{route('admin.manzana.edit',$manzana)}}">

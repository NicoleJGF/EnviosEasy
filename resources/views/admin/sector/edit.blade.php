    ...
    <div class="shadow-lg rounded-2xl bg-white dark:bg-gray-700 w-full">
        ...
        <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
            ...
            <div class="text-center flex justify-between">
                <h6 class="text-sky-500 text-xl font-bold">Editando Sector {{$sector->abreviatura}}</h6>
                {{----------
            ...
            {!!Form::model($sector, ['route' => ['admin.sector.update',$sector],'method'=>'put'])!!}
                ...
                <div class="w-full lg:w-12/12 px-4">
                    ...
                    {!! Form::textarea('descripcion', null, ['class' => 'border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white
                        rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150','placeholder' => 'Lorem a heart ...']) !!}
                        @error('descripcion')
                            <span class="text-pink-800">{{$message}}</span>
                        @enderror
                    </div>

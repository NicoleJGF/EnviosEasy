          ...
          <div class="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 ">
              <ul class="flex items-center flex-wrap mb-6 md:mb-0">
                  <li><a href="#" class="text-sm font-normal text-gray-500
                        hover:underline mr-4 md:mr-6">Administrando Sectores</a></li>
              </ul>
              <div class="flex sm:justify-center space-x-6">
                  <a href="{{route('admin.sector.create')}}" class="text-gray-500 hover:text-gray-900">
                ...
                {{----------------}}
                  ...
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-6 py-4 flex justify-end gap-4">
                        <a x-data="{ tooltip: 'Edite' }" href="{{route('admin.sector.edit',$sector)}}">
                        ...
                        <div x-data="{ open: false }">
                            ...
                            <div x-show="open" class="fixed inset-0 flex items-center justify-center z-50">
                                ...
                                <div class="bg-white p-8 rounded shadow-lg z-10">
                                  ...
                                  <p class="text-base text-red-500">¿Estás seguro que deseas eliminar el registro <strong>{{$sector->abreviatura}}</strong> ?</p>

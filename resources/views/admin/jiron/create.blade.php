        ...
        <div class="shadow-lg rounded-2xl bg-white dark:bg-gray-700 w-full">
            ...
            <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
                ...
                <div class="text-center flex justify-between">
                    <h6 class="text-blueGray-500 text-xl font-bold">Registrando Jiron</h6>
                    {{----------
                ...
                {!!Form::open(['route' => 'admin.jiron.store'])!!}
                    ...
                    <div class="w-full lg:w-4/12 px-4 mt-4">
                      <div class="relative w-full mb-3">
                      {!! Form::label('tipo', 'Tipo', ['class' => 'block text-sm font-medium text-sky-600 mb-2']) !!}
                      {!! Form::text('tipo', null, ['class' => 'border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white
                          rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150','placeholder' => 'AV.']) !!}
                          @error('tipo')
                              <span class="text-pink-800">{{$message}}</span>
                          @enderror
                    ...
                    <div class="w-full lg:w-12/12 px-4">
                        ...
                        {!! Form::textarea('descripcion', null, ['class' => 'border-0 px-3 py-3 placeholder-blueGray-300 text-blueGray-600 bg-white
                            ...
                            duration-150','placeholder' => 'Escribe una Descripcion ...']) !!}
                            @error('descripcion')
                                <span class="text-pink-800">{{$message}}</span>
                            @enderror
                        </div>
                    ...
                    <div class="w-full lg:w-12/12 px-4">
                        <div class="relative w-full mb-3  flex justify-end ">
                            {!! Form::submit('Registrar Jiron', ['class' => 'text-white bg-gradient-to-r from-sky-500 via-sky-600 to-sky-800 

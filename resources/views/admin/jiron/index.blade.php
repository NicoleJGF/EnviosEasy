            ...
            <div class="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 ">
                <ul class="flex items-center flex-wrap mb-6 md:mb-0">
                    <li><a href="#" class="text-sm font-normal text-gray-500
                            hover:underline mr-4 md:mr-6">Administrando Jirones</a></li>
                </ul>
                <div class="flex sm:justify-center space-x-6">
                    <a href="{{route('admin.jiron.create')}}" class="text-gray-500 hover:text-gray-900">
            ...
            <table class="table_id w-full text-sm text-left text-sky-500 dark:text-sky-400">
                ...
                <tbody>{{----------------}}
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            @if ($jiron->sector_jiron->count() > 0)
                                <ul>
                                    @foreach ($jiron->sector_jiron as $m)
                                        <li>{{ $m->abreviatura }}</li>
                                    @endforeach
                                </ul>
                            @else
                        ...
                        <td class="px-6 py-4 flex justify-end gap-4">
                            <a x-data="{ tooltip: 'Edite' }" href="{{route('admin.jiron.edit',$jiron)}}">
